...
impl_action! {
    ...
    onchange(name: "change", event: Event) -> ChangeData => |this: &Element, _| { crate::djed::listener::listener::onchange_handler(this) }
    ...
    oninput(name: "input", event: InputEvent) -> InputData => |this: &Element, _| { crate::djed::listener::listener::oninput_handler(this) }
