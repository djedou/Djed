...
pub enum ComponentUpdate<COMP: Component> {
    /// Force update
    Force,
    /// Wraps messages for a component.
    Message(COMP::State),
    /// Wraps batch of messages for a component.
    MessageBatch(Vec<COMP::State>),
    /// Wraps properties and next sibling for a component.
    Properties(COMP::Props, NodeRef),
}
...
impl<COMP: Component> Scope<COMP> {
    ...
    pub fn send_message_batch(&self, messages: Vec<COMP::State>) {
