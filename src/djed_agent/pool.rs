...
use super::agent::{Bridge, Discoverer, HandlerId, Agent};
...
pub type SharedOutputSlab<AGN> = Shared<Slab<Option<Callback<<AGN as Agent>::Output>>>>;
...
pub fn locate_callback_and_respond<AGN: Agent>(
