...
use crate::utils;
use crate::djed_agent::{HandlerId, Agent, };
use js_sys::{Array, Reflect, Uint8Array, global};
...
pub fn worker_new(name_of_resource: &str, is_module: bool) -> Worker {
